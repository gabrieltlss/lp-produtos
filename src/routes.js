...
const { createProductPage, createNewProduct, updateProductPage, updateProductController, deleteProductPage, deleteProductController } = require("./controllers/admin-product-controller");
...
router.get("/admin/product/update", updateProductPage);
router.post("/admin/product/update/post", uploadImg.single("image-input"), updateProductController);
router.get("/admin/product/delete", deleteProductPage);
